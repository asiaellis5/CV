...
| ---|---| ---|
| [Covid-19-Mapper](https://github.com/davidpaps/covid_19_mapper) | Project I have started since graduating from Makers. Single page React application that visually represents the covid-19 outbreak pulling in data through an API to show different statistics about the virus. | React, JavaScript, Bootstrap, CSS, HTML, Heroku, Jest
